...
+
image:aws-config-001.png["Figure showing input/output dialog or representing written content"]

. Configure the AWS region, deployment, and host type and the SDDC name:
+
image:aws-config-002.png["Figure showing input/output dialog or representing written content"]

. Connect to the desired AWS account and execute the AWS Cloud Formation stack.
+
image:aws-config-003.png["Figure showing input/output dialog or representing written content"]
image:aws-config-004.png["Figure showing input/output dialog or representing written content"]
image:aws-config-005.png["Figure showing input/output dialog or representing written content"]
image:aws-config-006.png["Figure showing input/output dialog or representing written content"]
+
NOTE: Single-host configuration is used in this validation.

. Select the desired AWS VPC to connect the VMC environment with.
+
image:aws-config-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-config-008.png["Figure showing input/output dialog or representing written content"]

. Review and acknowledge the SDDC configuration, and then click deploy the SDDC.
+
image:aws-config-009.png["Figure showing input/output dialog or representing written content"]
+
The deployment process typically takes approximately two hours to complete.
+
image:aws-config-010.png["Figure showing input/output dialog or representing written content"]

. After completion, the SDDC is ready for use.
+
image:aws-config-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-002.png["Figure showing input/output dialog or representing written content"]
image:aws-connect-fsx-003.png["Figure showing input/output dialog or representing written content"]
image:aws-connect-fsx-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-005.png["Figure showing input/output dialog or representing written content"]
image:aws-connect-fsx-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-007.png["Figure showing input/output dialog or representing written content"]
image:aws-connect-fsx-008.png["Figure showing input/output dialog or representing written content"]

. Create the Transit Gateway Attachment.
+
image:aws-connect-fsx-009.png["Figure showing input/output dialog or representing written content"]

. Back on the VMC Console, Accept the VPC attachment. This process can take approximately 10 minutes to complete.
+
image:aws-connect-fsx-010.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-connect-fsx-013.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-setup.adoc
