...
image:dr-vmc-aws-001.png["Figure showing input/output dialog or representing written content"]
...
link:vmw-aws-vmc-dr-prereqs.html[DR Solution Requirements, Pre-requisites and Planning]
...
+
image:dr-vmc-aws-010.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:dr-vmc-aws-011.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:dr-vmc-aws-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-013.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:dr-vmc-aws-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-016.png["Figure showing input/output dialog or representing written content"]
...
image:dr-vmc-aws-017.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-018.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-019.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-020.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-021.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-022.png["Figure showing input/output dialog or representing written content"]
====
...
image:dr-vmc-aws-023.png["Figure showing input/output dialog or representing written content"]
...
image:dr-vmc-aws-024.png["Figure showing input/output dialog or representing written content"]
====
...
image:dr-vmc-aws-025.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-026.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-027.png["Figure showing input/output dialog or representing written content"]

. Add your credentials to access the ONTAP cluster.
+
image:dr-vmc-aws-028.png["Figure showing input/output dialog or representing written content"]

. On the NAS Filer page choose the desired protocols to scan and select Next.
+
image:dr-vmc-aws-029.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-030.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-031.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-032.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:dr-vmc-aws-033.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-034.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-035.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-037.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-038.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-039.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-040.png["Figure showing input/output dialog or representing written content"]

. Expand the Auth section and click Try it Out.
+
image:dr-vmc-aws-041.png["Figure showing input/output dialog or representing written content"]

. In the UserOperationContext area, fill in the SnapCenter credentials and role and click Execute.
+
image:dr-vmc-aws-042.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-043.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:dr-vmc-aws-044.png["Figure showing input/output dialog or representing written content"]

. Expand the `/4.6/disasterrecovery/server/backup` section and click Try it Out.
+
image:dr-vmc-aws-045.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-046.png["Figure showing input/output dialog or representing written content"]
...
image:dr-vmc-aws-047.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:dr-vmc-aws-048.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-049.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-050.png["Figure showing input/output dialog or representing written content"]
+
image:dr-vmc-aws-051.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-052.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:dr-vmc-aws-053.png["Figure showing input/output dialog or representing written content"]

. Select Amazon S3 as the Object Storage type.
+
image:dr-vmc-aws-054.png["Figure showing input/output dialog or representing written content"]

. From the list of Amazon Cloud Storage Services, select Amazon S3.
+
image:dr-vmc-aws-055.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-056.png["Figure showing input/output dialog or representing written content"]

. On the Bucket page, enter the data center, bucket, folder, and any desired options. Click Apply.
+
image:dr-vmc-aws-057.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-058.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-059.png["Figure showing input/output dialog or representing written content"]

. After the import is complete, you can restore VMs into the VMware Cloud cluster.
+
image:dr-vmc-aws-060.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:dr-vmc-aws-061.png["Figure showing input/output dialog or representing written content"]

. On the first page of the Full VM Restore wizard, modify the VMs to backup if desired and select Next.
+
image:dr-vmc-aws-062.png["Figure showing input/output dialog or representing written content"]

. On the Restore Mode page,  select Restore to a New Location, or with Different Settings.
+
image:dr-vmc-aws-063.png["Figure showing input/output dialog or representing written content"]

. On the host page, select the Target ESXi host or cluster to restore the VM to.
+
image:dr-vmc-aws-064.png["Figure showing input/output dialog or representing written content"]

. On the Datastores page, select the target datastore location for both the configuration files and hard disk.
+
image:dr-vmc-aws-065.png["Figure showing input/output dialog or representing written content"]

. On the Network page, map the original networks on the VM to the networks in the new target location.
+
image:dr-vmc-aws-066.png["Figure showing input/output dialog or representing written content"]
+
image:dr-vmc-aws-067.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-068.png["Figure showing input/output dialog or representing written content"]

. From the Discovery tab, click Discover Portal and enter the IP addresses for your FSx iSCSI targets.
+
image:dr-vmc-aws-069.png["Figure showing input/output dialog or representing written content"]
+
image:dr-vmc-aws-070.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-071.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-072.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:dr-vmc-aws-073.png["Figure showing input/output dialog or representing written content"]

. Click Add and navigate to the folder containing the SQL Server primary database file, select it, and click OK.
+
image:dr-vmc-aws-074.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-075.png["Figure showing input/output dialog or representing written content"]
====
...
image:dr-vmc-aws-076.png["Figure showing input/output dialog or representing written content"]
====
...
....
+
image:dr-vmc-aws-077.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:dr-vmc-aws-078.png["Figure showing input/output dialog or representing written content"]

. Update the junction-path in the Amazon FSx web client:
+
image:dr-vmc-aws-079.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-vmc-aws-080.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:dr-vmc-aws-081.png["Figure showing input/output dialog or representing written content"]

. From the action menu, select Mount Command to view and copy the mount command to be used on our Oracle Linux server.
+
image:dr-vmc-aws-082.png["Figure showing input/output dialog or representing written content"]
+
image:dr-vmc-aws-083.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-guest-dr-solution-overview.adoc
