...
image:dr-vmc-aws-002.png["Figure showing input/output dialog or representing written content"]
...
image:dr-vmc-aws-003.png["Figure showing input/output dialog or representing written content"]
=====
...
image:dr-vmc-aws-004.png["Figure showing input/output dialog or representing written content"]
=====
...
image:dr-vmc-aws-005.png["Figure showing input/output dialog or representing written content"]
...
image:dr-vmc-aws-006.png["Figure showing input/output dialog or representing written content"]
=====
...
image:dr-vmc-aws-007.png["Figure showing input/output dialog or representing written content"]
...
image:dr-vmc-aws-008.png["Figure showing input/output dialog or representing written content"]
=====
...
image:dr-vmc-aws-009.png["Figure showing input/output dialog or representing written content"]
====
...
For a list of steps to be completed on the SnapCenter Server residing in AWS, see the section link:vmw-aws-vmc-guest-storage-dr.html#deploy-secondary-snapcenter[Deploy Secondary Windows SnapCenter Server].
=====
...
For a complete list of steps required to complete failover of the application VMs, see the section link:vmw-aws-vmc-guest-storage-dr.html#deploy-secondary-veeam[Deploy Secondary Veeam Backup & Replication Server].
=====
====


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-guest-dr-solution-prereqs.adoc
