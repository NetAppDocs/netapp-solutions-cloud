...
image:dr-veeam-anf-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-004.png["Figure showing input/output dialog or representing written content"]

. In the next step, create the mapping between source and destination virtual network as needed.
+
image:dr-veeam-anf-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-006.png["Figure showing input/output dialog or representing written content"]

. Choose the replication schedule to run the replication job to run on a regular basis.
+
image:dr-veeam-anf-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-008.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-anf-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-010.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-anf-011.png["Figure showing input/output dialog or representing written content"]

. Add the VMs to the plan and modify the VM boot order and boot delays to meet the application dependencies.
+
image:dr-veeam-anf-012.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-anf-013.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-anf-014.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-anf-015.png["Figure showing input/output dialog or representing written content"]

Once the failover is complete, the status of the VMs will change to "Failover".

image:dr-veeam-anf-016.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-anf-017.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-anf-018.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-anf-019.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-anf-020.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-anf-021.png["Figure showing input/output dialog or representing written content"]

After failback to production is successful, the VMs are all restored back to the original production site.

image:dr-veeam-anf-022.png["Figure showing input/output dialog or representing written content"]
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/veeam-anf-dr-to-avs.adoc
