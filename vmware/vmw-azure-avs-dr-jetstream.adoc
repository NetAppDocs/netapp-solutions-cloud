...
+
image:vmware-dr-008.png["Figure showing input/output dialog or representing written content"]

. From the JetStream DR interface, select the appropriate cluster.
+
image:vmware-dr-009.png["Figure showing input/output dialog or representing written content"]

. Configure the cluster with the I/O filter package.
+
image:vmware-dr-010.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmware-dr-012.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-013.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmware-dr-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmware-dr-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmware-dr-016.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmware-dr-017.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:vmware-dr-018.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:vmware-dr-019.png["Figure showing input/output dialog or representing written content"]
+
image:vmware-dr-020.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmware-dr-021.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:vmware-dr-022.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-023.png["Figure showing input/output dialog or representing written content"]


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-native-dr-jetstream.adoc
