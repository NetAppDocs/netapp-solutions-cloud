...
image:vmware-dr-001.png["Figure showing input/output dialog or representing written content"]
...
* Validate network connectivity and access the private cloud. Refer to this link:vmw-azure-avs-overview.html[link^] for a step-by-step walkthrough of the Azure VMware solution SDDC provisioning process.
...
image:vmware-dr-002.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-003.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-004.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-005.png["Figure showing input/output dialog or representing written content"]
====
...
image:vmware-dr-006.png["Figure showing input/output dialog or representing written content"]
...
image:vmware-dr-007.png["Figure showing input/output dialog or representing written content"]
======
...
link:vmw-azure-avs-dr-jetstream.html[DR solution with ANF, JetStream and AVS].
======
=====


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-native-nfs-datastore-option.adoc
