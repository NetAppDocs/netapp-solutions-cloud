...
image:bxp-scv-hybrid-040.png[ONTAP data storage]
...
image:bxp-scv-hybrid-001.png[Fan-out topology,800,418]
...
image:bxp-scv-hybrid-002.png[Cascading topology]
...
image:bxp-scv-hybrid-003.png[Cascading topology]
...
image:bxp-scv-hybrid-004.png[Solution Architecture Diagram]
...
+
image:bxp-scv-hybrid-041.png[Drag and drop storage systems]

. From the menu that appears select *Replication*.
+
image:bxp-scv-hybrid-042.png[Select replication]
...
+
image:bxp-scv-hybrid-043.png[Choose Intercluster LIFs]
...
+
image:bxp-scv-hybrid-044.png[Select source volume]
+
image:bxp-scv-hybrid-045.png[Destination volume details]

. Choose the max transfer rate for replication to occur at.
+
image:bxp-scv-hybrid-046.png[Max transfer rate]
...
+
image:bxp-scv-hybrid-009.png[Create resource groups]
...
+
image:bxp-scv-hybrid-010.png[Select datastores and virtual machines]
+
...
+
image:bxp-scv-hybrid-012.png[Resource group policy]
+
...
+
image:bxp-scv-hybrid-013.png[Resource group policy]
...
+
image:bxp-scv-hybrid-014.png[Run a backup job]
...
+
image:bxp-scv-hybrid-015.png[Monitor job progress]
=====
...
+
image:bxp-scv-hybrid-019.png[Select virtual machines]
...
+
image:bxp-scv-hybrid-020.png[Setting drop down menu]
...
+
image:bxp-scv-hybrid-021.png[Enter SCV and vCenter info]

. The progress of jobs can be monitored from the Job Monitoring tab.
+
image:bxp-scv-hybrid-022.png[View job progress]
...
+
image:bxp-scv-hybrid-023.png[View available resources]
=====
...
+
image:bxp-scv-hybrid-024.png[Select virtual machines]
...
+
image:bxp-scv-hybrid-025.png[Create backup policy]
+
...
+
image:bxp-scv-hybrid-026.png[Activate backup]

. Assign the policy to be used for the data protection operation and click on *Next*.
+
image:bxp-scv-hybrid-027.png[Assign policy]
...
+
image:bxp-scv-hybrid-028.png[Add working environments]

. At the *Select Provider* page click on AWS and then click on the *Next* button to continue.
+
image:bxp-scv-hybrid-029.png[Select cloud provider]
...
+
image:bxp-scv-hybrid-030.png[Provide cloud provide credentials]
...
+
image:bxp-scv-hybrid-031.png[Review and activate]
+
...
+
image:bxp-scv-hybrid-032.png[Access list of backups]

. Click on a backup to access the list of VMs and then select a VM to restore. Click on *Restore*.
+
image:bxp-scv-hybrid-033.png[Select VM to restore]
...
+
image:bxp-scv-hybrid-034.png[Provide restore details]

. Choose to backup from the primary or secondary storage location.
+
image:bxp-scv-hybrid-035.png[Choose primary or secondary]
...
+
image:bxp-scv-hybrid-036.png[Access list of VMs]

. Access the settings drop down menu for the VM to be restored and select 
+
image:bxp-scv-hybrid-037.png[Select restore from settings]

. Select the backup to restore from and click on *Next*.
+
image:bxp-scv-hybrid-038.png[Select backup]
...
+
image:bxp-scv-hybrid-039.png[Review restore from Job Monitoring tab]
=====
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/bxp-scv-hybrid-solution.adoc
