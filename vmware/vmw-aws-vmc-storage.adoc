...
* link:vmw-aws-vmc-nfs-ds-overview.html[FSx ONTAP as a Supplemental NFS Datastore: Overview]
* link:vmw-aws-vmc-nfs-ds-config.html[Amazon FSx for ONTAP as a Supplement datastore]
...
For more information, please visit link:vmw-aws-vmc-guest-storage.html#fsx-ontap[FSx ONTAP as Guest Connected Storage]
...
For more information, please visit link:vmw-aws-vmc-guest-storage.html#aws-cvo[CVO as Guest Connected Storage].


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-storage-options.adoc
