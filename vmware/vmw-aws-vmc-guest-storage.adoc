...
image:aws-fsx-guest-001.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-002.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-003.png["Figure showing input/output dialog or representing written content"]

. In the Networking section, for Virtual Private Cloud (VPC), choose the appropriate VPC and preferred subnets along with the route table. In this case, vmcfsx2.vpc is selected from the dropdown.

image:aws-fsx-guest-004.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-005.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-006.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-007.png["Figure showing input/output dialog or representing written content"]

. Review the file system configuration shown on the Create File System page.

. Click Create File System.

image:aws-fsx-guest-008.png["Figure showing input/output dialog or representing written content"]
image:aws-fsx-guest-009.png["Figure showing input/output dialog or representing written content"]
image:aws-fsx-guest-010.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-011.png["Figure showing input/output dialog or representing written content"]
=====
...
image:aws-fsx-guest-020.png["Figure showing input/output dialog or representing written content"]

. Once executed, run the df command to validate the mount.

image:aws-fsx-guest-021.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-022.png["Figure showing input/output dialog or representing written content"]

. In the Shared Folders tool, choose Shares in the left pane to see the active shares for the Amazon FSx file system.

image:aws-fsx-guest-023.png["Figure showing input/output dialog or representing written content"]

. Now choose a new share and complete the Create a Shared Folder wizard.

image:aws-fsx-guest-024.png["Figure showing input/output dialog or representing written content"]
image:aws-fsx-guest-025.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-026.png["Figure showing input/output dialog or representing written content"]
=====
...
image:aws-fsx-guest-030.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-031.png["Figure showing input/output dialog or representing written content"]
...
image:aws-fsx-guest-032.png["Figure showing input/output dialog or representing written content"]
=====
...
image:aws-cvo-guest-001.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-002.png["Figure showing input/output dialog or representing written content"]

. Provide the details of the environment to be created including the environment name and admin credentials. Click Continue.

image:aws-cvo-guest-003.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-004.png["Figure showing input/output dialog or representing written content"]

. On the HA Deployment Models page, choose the Multiple Availability Zones configuration.

image:aws-cvo-guest-005.png["Figure showing input/output dialog or representing written content"]

. On the Region & VPC page, enter the network information and then click Continue.

image:aws-cvo-guest-006.png["Figure showing input/output dialog or representing written content"]

. On the Connectivity and SSH Authentication page, choose connection methods for the HA pair and the mediator.

image:aws-cvo-guest-007.png["Figure showing input/output dialog or representing written content"]

. Specify the floating IP addresses and then click Continue.

image:aws-cvo-guest-008.png["Figure showing input/output dialog or representing written content"]

. Select the appropriate route tables to include routes to the floating IP addresses and then click Continue.

image:aws-cvo-guest-009.png["Figure showing input/output dialog or representing written content"]

. On the Data Encryption page, choose AWS-managed encryption.

image:aws-cvo-guest-010.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-011.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-012.png["Figure showing input/output dialog or representing written content"]

. On the Review & Approve page, review and confirm the selections.To create the Cloud Volumes ONTAP instance, click Go.

image:aws-cvo-guest-013.png["Figure showing input/output dialog or representing written content"]

. After Cloud Volumes ONTAP is provisioned, it is listed in the working environments on the Canvas page.

image:aws-cvo-guest-014.png["Figure showing input/output dialog or representing written content"]
=====
...
image:aws-cvo-guest-020.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-021.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-022.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-023.png["Figure showing input/output dialog or representing written content"]
image:aws-cvo-guest-024.png["Figure showing input/output dialog or representing written content"]
=====
...
image:aws-cvo-guest-030.png["Figure showing input/output dialog or representing written content"]
image:aws-cvo-guest-031.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-032.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-033.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-034.png["Figure showing input/output dialog or representing written content"]
...
image:aws-cvo-guest-040.png["Figure showing input/output dialog or representing written content"]
image:aws-cvo-guest-041.png["Figure showing input/output dialog or representing written content"]
=====


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-guest.adoc
