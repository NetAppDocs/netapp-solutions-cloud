...
+
image:fsx-nfs-002.png["Figure showing input/output dialog or representing written content"]

. For the creation method, choose *Standard Create*.
+
image:fsx-nfs-003.png["Figure showing input/output dialog or representing written content"]
+
image:fsx-nfs-004.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-nfs-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-008.png["Figure showing input/output dialog or representing written content"]
+
image:fsx-nfs-009.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-nfs-010.png["Figure showing input/output dialog or representing written content"]
+
image:fsx-nfs-011.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-nfs-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-013.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:fsx-nfs-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-015.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-nfs-016.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-017.png["Figure showing input/output dialog or representing written content"]

. Click *Create* *transit gateway attachment*.
+
image:fsx-nfs-018.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-019.png["Figure showing input/output dialog or representing written content"]
+
image:fsx-nfs-020.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-nfs-021.png["Figure showing input/output dialog or representing written content"]
+
image:fsx-nfs-022.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:fsx-nfs-023.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-024.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-nfs-025.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-nfs-027.png["Figure showing input/output dialog or representing written content"]
...
image:fsx-nfs-028.png["Figure showing input/output dialog or representing written content"]

. Click *ATTACH DATASTORE* to attach the datastore to the cluster.
+
image:fsx-nfs-029.png["Figure showing input/output dialog or representing written content"]

. Validate the NFS datastore by accessing vCenter as shown below:
+
image:fsx-nfs-030.png["Figure showing input/output dialog or representing written content"]
=====


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-native-nfs-datastore-option.adoc
