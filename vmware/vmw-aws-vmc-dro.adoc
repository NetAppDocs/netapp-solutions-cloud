...
image:dro-vmc-001.png["This graphic depicts the structure and interconnections between an on-premises data center, a VMware Cloud on AWS SDDC instance, and Amazon FSx ONTAP. This includes SnapMirror replication, DRaaS Ops traffic, internet or direct connect, and VMware Transit Connect."]

== Getting started  

=== Deploy and configure VMware Cloud on AWS

link:https://www.vmware.com/products/vmc-on-aws.html[VMware Cloud on AWS^] provides a cloud-native experience for VMware-based workloads in the AWS ecosystem. Each VMware Software-Defined Data Center (SDDC) runs in an Amazon Virtual Private Cloud (VPC) and provides a full VMware stack (including vCenter Server), NSX-T software-defined networking, vSAN software-defined storage, and one or more ESXi hosts that provide compute and storage resources to the workloads. To configure a VMC environment on AWS, follow the steps at this link:vmw-aws-vmc-setup.html[link^]. A pilot-light cluster can also be used for DR purposes. 
...
Amazon FSx ONTAP is a fully managed service that provides highly reliable, scalable, high-performing, and feature-rich file storage built on the popular NetApp ONTAP file system. Follow the steps at this link:vmw-aws-vmc-nfs-ds-overview.html[link^] to provision and configure FSx ONTAP.
...
image:dro-vmc-002.png["This graphic depicts the BlueXP Canvas relationship map that shows the various interactions between enabled services."]
...
image:dro-vmc-003.png["Disaster Recovery Orchestrator Login screen."]
...
image:dro-vmc-004.png["Temporary placeholder image description."]

image:dro-vmc-005.png["DRO site overview page containing Source and Destination sites."]
...
image:dro-vmc-006.png["Automatic discovery screen containing 219 VMs and 10 datastores."]
...
image:dro-vmc-007.png["Screenshot of Resource group list with two entries: Test and DemoRG1."]
...
+
image:dro-vmc-008.png["Screenshot of the replication plan screen containing one plan called DemoRP."]
...
+
image:dro-vmc-009.png["Screenshot of replication plan details, including the recovery mapping."]

. After Recovery mapping is completed, select the cluster mapping.
+
image:dro-vmc-010.png["Temporary placeholder image description."]
...
+
image:dro-vmc-011.png["Temporary placeholder image description."]
...
+
image:dro-vmc-012.png["Temporary placeholder image description."]

. Click *Create Replication Plan*.
+
image:dro-vmc-013.png["Temporary placeholder image description."]
...
image:dro-vmc-014.png["Temporary placeholder image description."]
image:dro-vmc-015.png["In this screen, you are provided with the Volume Snapshot details and are given the choice between using the latest snapshot and choosing a specific snapshot."]

The replication plan can be monitored in the task menu:

image:dro-vmc-016.png["The task menu shows all jobs and options for the replication plan, and also allows you to see the logs."]
...
image:dro-vmc-017.png["Temporary placeholder image description."]
...
image:dro-vmc-018.png["Screenshot of Replication Plan overview with dropdown containing Reverse Data Sync option."]
image:dro-vmc-019.png["Temporary placeholder image description."]

Once completed, you can trigger failback to move back to original production site.

image:dro-vmc-020.png["Screenshot of Replication Plan overview with dropdown containing the Failback option."]
image:dro-vmc-021.png["Screenshot of DRO summary page with original production site up and running."]
...
image:dro-vmc-022.png["Temporary placeholder image description."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-dro-overview.adoc
