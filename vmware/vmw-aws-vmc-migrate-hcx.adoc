...
. Use an existing VMC SDDC or create a new SDDC following this link:vmw-aws-vmc-setup.html[NetApp link^] or this https://docs.vmware.com/en/VMware-Cloud-on-AWS/services/com.vmware.vmc-aws.getting-started/GUID-EF198D55-03E3-44D1-AC48-6E2ABA31FF02.html[VMware link^].
...
image:fsx-hcx-001.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:fsx-hcx-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-007.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
image:fsx-hcx-008.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:fsx-hcx-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-010.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
HCX information can be retrieved from the SDDC Settings page.
+
image:fsx-hcx-011.png["Figure showing input/output dialog or representing written content"]
+
image:fsx-hcx-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-013.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-014.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:fsx-hcx-015.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-hcx-016.png["Figure showing input/output dialog or representing written content"]

. Select the service to be activated and click Continue.
+
image:fsx-hcx-017.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:fsx-hcx-018.png["Figure showing input/output dialog or representing written content"]
=====
...
image:fsx-hcx-019.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-020.png["Figure showing input/output dialog or representing written content"]

. In the Migrate Virtual Machine wizard,  select the Remote Site Connection (target VMC SDDC). 
+
image:fsx-hcx-021.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-022.png["Figure showing input/output dialog or representing written content"]
...
+
image:fsx-hcx-023.png["Figure showing input/output dialog or representing written content"]
======
...
image:fsx-hcx-024.png["Figure showing input/output dialog or representing written content"]
...
image:fsx-hcx-025.png["Figure showing input/output dialog or representing written content"]
======
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/aws-migrate-vmware-hcx.adoc
