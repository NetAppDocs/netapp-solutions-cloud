...
* link:vmw-azure-avs-nfs-ds-overview.html[ANF as a Supplemental NFS Datastore: Overview]
* link:vmw-azure-avs-nfs-ds-config.html[Supplemental NFS Datastore Option in Azure]
...
For more information, please visit link:vmw-azure-avs-guest-storage.html#anf[ANF as Guest Connected Storage].
...
For more information, please visit link:vmw-azure-avs-guest-storage.html#azure-cvo[CVO as Guest Connected Storage].


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-storage-options.adoc
