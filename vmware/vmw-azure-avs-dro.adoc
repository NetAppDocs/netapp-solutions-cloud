...
image:azure-dro-001.png["Figure showing input/output dialog or representing written content"]
...
image:azure-dro-002.png["Figure showing input/output dialog or representing written content"]
...
** Password: `admin`
+
image:azure-dro-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-004.png["Figure showing input/output dialog or representing written content"]
+
...
** Azure NetApp Files storage account
+
image:azure-dro-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-006.png["Figure showing input/output dialog or representing written content"]

. Select the Source Storge details (ANF) by selecting the Azure Resource group and NetApp account.
. Click *Create Site*.
+
image:azure-dro-007.png["Figure showing input/output dialog or representing written content"]
...
image:azure-dro-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-010.png["Figure showing input/output dialog or representing written content"]

. Click *Create Resource Group*.
+
image:azure-dro-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-013.png["Figure showing input/output dialog or representing written content"]

. After recovery mapping is complete, select the *Cluster Mapping*.
+
image:azure-dro-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-016.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-dro-017.png["Figure showing input/output dialog or representing written content"]
...
image:azure-dro-018.png["Figure showing input/output dialog or representing written content"]
...
image:azure-dro-019.png["Figure showing input/output dialog or representing written content"]
...
image:azure-dro-020.png["Figure showing input/output dialog or representing written content"]
...
image:azure-dro-021.png["Figure showing input/output dialog or representing written content"]

After this step is complete,  trigger failback to move back to the primary AVS site.

image:azure-dro-022.png["Figure showing input/output dialog or representing written content"]

image:azure-dro-023.png["Figure showing input/output dialog or representing written content"]
...
+
link:vmw-azure-avs-setup.html[Setup AVS on Azure]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-dro-overview.adoc
