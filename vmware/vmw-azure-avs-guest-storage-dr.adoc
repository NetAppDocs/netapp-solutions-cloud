...
image:dr-cvo-avs-001.png["Figure showing input/output dialog or representing written content"]
...
[%collapsible%open]
=====
The first step is to configure Cloud Volumes ONTAP on Azure (link:vmw-azure-avs-guest-storage.html[Link^]) and replicate the desired volumes to Cloud Volumes ONTAP with the desired frequencies and snapshot retentions.

image:dr-cvo-avs-002.png["Figure showing input/output dialog or representing written content"]
=====
...
To configure AVS SDDC (be it on-demand or in pilot-light mode), see link:vmw-azure-avs-setup.html[Deploy and configure the Virtualization Environment on Azure^]. As a prerequisite, verify that the guest VMs residing on the AVS hosts are able to consume data from Cloud Volumes ONTAP after connectivity has been established.
...
+
image:dr-cvo-avs-003.png["Figure showing input/output dialog or representing written content"]

. From the JetStream DR interface, complete the following tasks:
.. Configure the cluster with the I/O filter package.
+
image:dr-cvo-avs-004.png["Figure showing input/output dialog or representing written content"]

.. Add the Azure Blob storage located at the recovery site.
+
image:dr-cvo-avs-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-006.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-009.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-010.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-011.png["Figure showing input/output dialog or representing written content"]

. Make sure that replication log volumes are placed on high- performance storage.
+
image:dr-cvo-avs-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-013.png["Figure showing input/output dialog or representing written content"]

. After replication is completed, the VM protection status is marked as Recoverable.
+
image:dr-cvo-avs-014.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:dr-cvo-avs-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-016.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-017.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-018.png["Figure showing input/output dialog or representing written content"]

. Click the Configure button to save NIC settings for the respective VMs.
+
image:dr-cvo-avs-019.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-020.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-021.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-022.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-023.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-024.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-025.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:dr-cvo-avs-026.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-027.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-028.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:dr-cvo-avs-029.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-030.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:dr-cvo-avs-031.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-032.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-033.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-034.png["Figure showing input/output dialog or representing written content"]

.. In the Settings page, navigate to Settings > Global Settings > Disaster Recovery.
.. Select Enable Disaster Recovery.
.. Click Apply.
+
image:dr-cvo-avs-035.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-036.png["Figure showing input/output dialog or representing written content"]

. Attach the LUN from Cloud Volumes ONTAP to the recovered SQL guest VM with same drive letters.
+
image:dr-cvo-avs-037.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-cvo-avs-038.png["Figure showing input/output dialog or representing written content"]

. Make sure that all the disks are connected using the same drive letters that were used prior to DR.
+
image:dr-cvo-avs-039.png["Figure showing input/output dialog or representing written content"]

. Restart the MSSQL server service.
+
image:dr-cvo-avs-040.png["Figure showing input/output dialog or representing written content"]

. Make sure that the SQL resources are back online.
+
image:dr-cvo-avs-041.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:dr-cvo-avs-042.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:dr-cvo-avs-043.png["Figure showing input/output dialog or representing written content"]

. Complete the failback process and then confirm the resumption of VM protection and data consistency.
+
image:dr-cvo-avs-044.png["Figure showing input/output dialog or representing written content"]

. After the VMs are recovered, disconnect the secondary storage from the host and connect to the primary storage.
+
image:dr-cvo-avs-045.png["Figure showing input/output dialog or representing written content"]
+
image:dr-cvo-avs-046.png["Figure showing input/output dialog or representing written content"]

. Restart the MSSQL server service.
. Verify that the SQL resources are back online.
+
image:dr-cvo-avs-047.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-guest-dr-cvo.adoc
