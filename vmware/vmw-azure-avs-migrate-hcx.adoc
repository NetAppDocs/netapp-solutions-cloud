...
* Use an existing Azure VMware solution software-defined data center (SDDC) or create a private cloud by using this link:vmw-azure-avs-setup.html[NetApp link^] or this https://docs.microsoft.com/en-us/azure/azure-vmware/deploy-azure-vmware-solution?tabs=azure-portal[Microsoft link^].
...
image:anfd-hcx-001.png[This image depicts the high-level architecture used in this solution.]
=====
...
+
image:anfd-hcx-002.png[Screenshot of the HCX Workload Mobility section.]
...
+
image:anfd-hcx-003.png[Screenshot of the completion of the HCX Workload Mobility section.]
=====
...
+
image:anfd-hcx-004.png[Screenshot of the Azure portal to download the HCX OVA file.]
...
+
image:anfd-hcx-005.png[Screenshot of OVA download link.]
...
+
image:anfd-hcx-006.png[Screenshot to select the correct OVA template.]
...
+
image:anfd-hcx-007.png[Screenshot for adding HCX keys.]
+
[NOTE]
...
+
image:anfd-hcx-008.png[Screenshot showing completed process.]
=====
...
image:anfd-hcx-009.png[Screenshot of the HCX vSphere Web Client plug-in.]
...
image:anfd-hcx-010.png[Screenshot URL or IP address and credentials for CloudAdmin role.]
...
image:anfd-hcx-011.png[Screenshot of the completed process on the HCX dashboard.]
=====
...
image:anfd-hcx-012.png[Screenshot of the vSphere client Interconnect page.]
...
image:anfd-hcx-013.png[Screenshot of adding IP addresses to the vSphere client Interconnect page.]
...
image:anfd-hcx-014.png[Screenshot of Service Mesh tab on the vSphere client Interconnect page.]
...
image:anfd-hcx-015.png[Screenshot of the completed process on the vSphere client Interconnect page.]
=====
...
image:anfd-hcx-016.png[Screenshot of the Migration section in the vSphere client.]
...
image:anfd-hcx-017.png[Screenshot of the Transfer and Placement section of the vSphere client.]

. After the validation checks are complete, click *Go* to initiate the migration.

image:anfd-hcx-018.png[Screenshot of migration initiation.]
...
image:anfd-hcx-019.png["Figure showing input/output dialog or representing written content"]
...
image:anfd-hcx-020.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-migrate-vmware-hcx.adoc
