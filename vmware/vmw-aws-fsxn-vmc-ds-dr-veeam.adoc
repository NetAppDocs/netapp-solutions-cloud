...
image:dr-veeam-fsx-001.png["Diagram of DR scenario using Veeam Replication and FSx ONTAP for VMC"]
...
+
image:dr-veeam-fsx-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-fsx-003.png["Figure showing input/output dialog or representing written content"]
...
+ 
image:dr-veeam-fsx-004.png["Figure showing input/output dialog or representing written content"]

. In the next step, create the mapping between source and destination virtual network as needed.
+
image:dr-veeam-fsx-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-fsx-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-fsx-007.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-fsx-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:dr-veeam-fsx-009.png["Figure showing input/output dialog or representing written content"]

. Add the VMs to the plan and modify the VM boot order and boot delays to meet the application dependencies.
+
image:dr-veeam-fsx-010.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-fsx-011.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-fsx-012.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-fsx-013.png["Figure showing input/output dialog or representing written content"]

Once the failover is complete, the status of the VMs will change to "Failover".

image:dr-veeam-fsx-014.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-fsx-015.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-fsx-016.png["Figure showing input/output dialog or representing written content"]
...
image:dr-veeam-fsx-017.png["Figure showing input/output dialog or representing written content"]

image:dr-veeam-fsx-018.png["Figure showing input/output dialog or representing written content"]

After failback to production is successful, the VMs are all restored back to the original production site.

image:dr-veeam-fsx-019.png["Figure showing input/output dialog or representing written content"]
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/veeam-fsxn-dr-to-vmc.adoc
