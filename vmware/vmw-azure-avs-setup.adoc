...
+
image:avs-register-create-pc-001.png["Figure showing input/output dialog or representing written content"]
+
image:avs-register-create-pc-002.png["Figure showing input/output dialog or representing written content"]
+
...
image:avs-register-create-pc-003.png["Figure showing input/output dialog or representing written content"]
...
image:avs-register-create-pc-004.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:azure-connect-gateway-001.png["Figure showing input/output dialog or representing written content"]
+
. Provide or update the information for the new VNet and select OK.

image:azure-connect-gateway-002.png["Figure showing input/output dialog or representing written content"]
...
image:azure-validate-network-001.png["Figure showing input/output dialog or representing written content"]

After the virtual machine is provisioned, use the Connect option to access RDP.

image:azure-validate-network-002.png["Figure showing input/output dialog or representing written content"]
...
image:azure-validate-network-003.png["Figure showing input/output dialog or representing written content"]
...
image:azure-validate-network-004.png["Figure showing input/output dialog or representing written content"]

image:azure-validate-network-005.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-setup.adoc
