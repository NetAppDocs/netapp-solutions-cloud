...
+
image:azure-anf-guest-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-anf-guest-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-anf-guest-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-anf-guest-004.png["Figure showing input/output dialog or representing written content"]

. Click Review + Create to create the SMB volume.
+
If the application is SQL Server, then enable the SMB continuous availability.
+
image:azure-anf-guest-005.png["Figure showing input/output dialog or representing written content"]
+
image:azure-anf-guest-006.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:azure-anf-guest-007.png["Figure showing input/output dialog or representing written content"]
+
image:azure-anf-guest-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-anf-guest-009.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:azure-cvo-guest-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-002.png["Figure showing input/output dialog or representing written content"]

. When creating the first Cloud Volumes ONTAP working environment, Cloud Manager prompts you to deploy a Connector.
+
image:azure-cvo-guest-003.png["Figure showing input/output dialog or representing written content"]

. After the connector is created, update the Details and Credentials fields.
+
image:azure-cvo-guest-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-006.png["Figure showing input/output dialog or representing written content"]

. Configure the Azure location and connectivity. Select the Azure Region, resource group, VNet, and subnet to be used.
+
image:azure-cvo-guest-007.png["Figure showing input/output dialog or representing written content"]

. Select the license option: Pay-As-You-Go or BYOL for using existing license. In this example, Pay-As-You-Go option is used.
+
image:azure-cvo-guest-008.png["Figure showing input/output dialog or representing written content"]

. Select between several preconfigured packages available for the various types of workloads.
+
image:azure-cvo-guest-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-010.png["Figure showing input/output dialog or representing written content"]

. After Cloud Volumes ONTAP is provisioned, it is listed in the working environments on the Canvas page.
+
image:azure-cvo-guest-011.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:azure-cvo-guest-020.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-021.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-022.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-023.png["Figure showing input/output dialog or representing written content"]
+
image:azure-cvo-guest-024.png["Figure showing input/output dialog or representing written content"]
=====
...
+
image:azure-cvo-guest-030.png["Figure showing input/output dialog or representing written content"]
...
+
image:azure-cvo-guest-031.png["Figure showing input/output dialog or representing written content"]
...
image:azure-cvo-guest-032.png["Figure showing input/output dialog or representing written content"]
...
image:azure-cvo-guest-033.png["Figure showing input/output dialog or representing written content"]

image:azure-cvo-guest-034.png["Figure showing input/output dialog or representing written content"]
=====


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/azure-guest.adoc
