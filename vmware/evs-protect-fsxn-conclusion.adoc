...
[.lead]
PLACEHOLDER This document has provided directions on how to set up FSx for ONTAP as an external storage for Amazon EVS for use with both the NFS and iSCSI protocols. 
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/evs-mount-fsxn-conclusion.adoc
