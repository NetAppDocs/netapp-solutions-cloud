...
[.lead]
PLACEHOLDER This section covers the steps to configure an iSCSI datastore using FSx for ONTAP.
...
+
image:evs-mount-fsxn-025.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-026.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-027.png[Figure representing the dialog for the above step]

. Select the SVM where you want to create the volume.
+
image:evs-mount-fsxn-028.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-029.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-030.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-031.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-032.png[Figure representing the dialog for the above step]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/evs-mount-fsxn-iscsi.adoc
