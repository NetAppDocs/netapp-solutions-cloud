...
NOTE: In-guest storage was the only available option at the time this document was written.
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/ehc-overview.adoc
