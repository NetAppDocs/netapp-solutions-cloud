...
+
image:evs-mount-fsxn-002.png[Figure representing the select file system type dialog]
...
+
image:evs-mount-fsxn-003.png[Figure representing the select file system type, standard create dialog]
+
...
+
image:evs-mount-fsxn-004.png[Figure representing the select file system type, standard create wizard]
...
+
image:evs-mount-fsxn-005.png[Figure representing the network security dialog]
...
+
image:evs-mount-fsxn-006.png[Figure representing the security and encryption dialog]
...
+
image:evs-mount-fsxn-007.png[Figure representing the Default storage virtual machine configuration dialog]
...
+
image:evs-mount-fsxn-008.png[Figure representing the Default volume configuration dialog]
...
+
image:evs-mount-fsxn-009.png[Figure representing the Storage Tiering dialog]
...
+
image:evs-mount-fsxn-010.png[Figure representing the completion of the file system creation dialog]
...
+
image:evs-mount-fsxn-011.png[Figure representing the file systems created dialog]
+
image:evs-mount-fsxn-012.png[Figure representing the file systems created dialog]
+
...
+
image:evs-mount-fsxn-013.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-014.png[Figure representing the dialog for the above step]
+
...
+
image:evs-mount-fsxn-015.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-016.png[Figure representing the dialog for the above step]
+
...
+
image:evs-mount-fsxn-017.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-018.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-019.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-020.png[Figure representing the dialog for the above step]
...
+
image:evs-mount-fsxn-021.png[Figure representing the dialog for the above step]

. In the "Host accessibility" step, select all the hosts that require access to the datastore, then click "NEXT" to continue.
+
image:evs-mount-fsxn-022.png[Figure representing the dialog for the above step]

. In the "Ready to complete" step, review the data and click "FINISH" to complete the set up.
+
image:evs-mount-fsxn-023.png[Figure representing the dialog for the above step]

. Validate that the NFS datastore has been connected by accessing vCenter, as shown below:
+
image:evs-mount-fsxn-024.png[Figure representing the dialog for the above step]


// NetApp Solutions restructuring (jul 2025) - renamed from ehc/evs-mount-fsxn-nfs.adoc
