...
Trident Protect creates application snapshots and backups. This means that snapshots and backups are created not only for application data in persistent volumes, but also for application metadata. The snapshots and backups created by Trident Protect can be stored in any of the following object storage and restored from them at a later point. 
...
1. Snapshot creation (on demand or scheduled)
...
====
Prior to creating the snapshots and backups for an application, object storage must be configured in Trident Protect to store the snapshots and backups. This is done using the bucket CR. Only administrators can create a bucket CR and configure it. 
...
image:rhhc-dp-tp-solution-container-001.png[AppVault created]
...
image:rhhc-dp-tp-solution-container-002.png[App created]
====
...
image:rhhc-dp-tp-solution-container-003.png[Snapshot created]

image:rhhc-dp-tp-solution-container-004.png[snapshot-pvc created]
...
image:rhhc-dp-tp-solution-container-005.png[Schedule1 created]
...
image:rhhc-dp-tp-solution-container-006.png[Schedule2 created]

You can see snapshots created on this schedule.

image:rhhc-dp-tp-solution-container-007.png[Snap created on schedule]

Volume snapshots are also created.

image:rhhc-dp-tp-solution-container-008.png[PVC Snap created on schedule]
...
image:rhhc-dp-tp-solution-container-009.png[Sir created]

Application and its PVCis restored to the same namespace.

image:rhhc-dp-tp-solution-container-010.png[App restored, Sir]
====
...
image:rhhc-dp-tp-solution-container-011.png[snapRestore created]

You can see that the application has been restored to a new namespace.
 
image:rhhc-dp-tp-solution-container-012.png[App restored, snapRestore]
...
image:rhhc-dp-tp-solution-container-013.png[Backup created]
...
Schedule "schedule1" created.
....
image:rhhc-dp-tp-solution-container-013-a.png[Schedule created previously]
...
image:rhhc-dp-tp-solution-container-014.png[Schedule created previously]
...
image:rhhc-dp-tp-solution-container-015.png[restore to the same namespace]

The application and the PVCs are restored in the same namespace.

image:rhhc-dp-tp-solution-container-016.png[applicatio and pvcs restore to the same namespace]

**Restore to a different namespace**
Create a new namespace.
Restore from a backup to the new namespace.

image:rhhc-dp-tp-solution-container-017.png[restore to a different namespace]
...
image:rhhc-dp-tp-solution-container-018.png[restore to a different namespace]
...
image:rhhc-dp-tp-solution-container-019.png[switch context to destination]
...
image:rhhc-dp-tp-solution-container-020.png[restore to destination]

You can now see that the application pods and the pvcs are created in the destination cluster.

image:rhhc-dp-tp-solution-container-021.png[app on destination cluster]

====

// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-dp-tp-solution.adoc
