...
image:rhhc-acs-add-001.png["Figure showing input/output dialog or representing written content"]

Click *Next* and select ontap-nas as the default storage class for ACS. Click *Next*, review the details and *Add* the cluster. 

image:rhhc-acs-add-002.png["Figure showing input/output dialog or representing written content"]
...
image:rhhc-app-restore-001.png["Figure showing input/output dialog or representing written content"]

image:rhhc-app-restore-002.png["Figure showing input/output dialog or representing written content"]

image:rhhc-app-restore-003.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-pm-data-protection.adoc
