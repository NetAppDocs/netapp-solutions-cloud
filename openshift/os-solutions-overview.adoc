...
**NetApp Trident Protect**, available as a free add-on to NetApp Trident, delivers advanced application data management capabilities that enhance the functionality and availability of stateful Kubernetes applications backed by NetApp ONTAP storage systems. Trident Protect simplifies the management, protection, and movement of containerized workloads across both public clouds and on-premises environments. It also offers robust automation capabilities through its API and CLI.
...
// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-overview.adoc
