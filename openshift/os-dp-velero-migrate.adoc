...
image:redhat-openshift-oadp-migrate-001.png[install postgres app]
...
image:redhat-openshift-oadp-migrate-002.png[install postgres app]
...
image:redhat-openshift-oadp-migrate-003.png[trident installed]

image:redhat-openshift-oadp-migrate-004.png[postgres not already installed]

image:redhat-openshift-oadp-migrate-005.png[OADP on cluster 2installed]

image:redhat-openshift-oadp-migrate-006.png[backup storage location pointing to the same object store]
...
image:redhat-openshift-oadp-migrate-007.png[restore success]

image:redhat-openshift-oadp-migrate-008.png[postgres migrated]

====

// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-dp-velero-migrate.adoc
