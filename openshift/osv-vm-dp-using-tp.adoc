...
= Protect VMs in Red Hat OpenShift Virtualization using Trident Protect
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Protect VMs in OpenShift Virtualization using snapshots and backups. This procedure includes creating an AppVault using ONTAP S3 object storage, configuring Trident Protect to capture VM data, including Kubernetes resource objects, persistent volumes, and internal images, and restoring the data when necessary.
...
The persistent disks of the OpenShift Virtualization VMs can be backed by ONTAP storage integrated to the OpenShift Cluster using link:https://docs.netapp.com/us-en/trident/[Trident CSI]. In this section we use link:https://docs.netapp.com/us-en/trident/trident-protect/learn-about-trident-protect.html[Trident Protect] to create snapshots and backups of VMs including their data volumes to ONTAP object storage.

We then restore from a snapshot or a backup when needed. 

Trident Protect enables snapshots, backups, restores, and disaster recovery of applications and VMs on an OpenShift cluster. For OpenShift Virtualization VMs, data that can be protected with Trident Protect include Kubernetes resource objects associated with the VMs, persistent volumes, and internal images.
...
[%collapsible%open]
====
Prior to creating the snapshots and backups for an application or a VM, object storage must be configured in Trident Protect to store the snapshots and backups. This is done using the bucket CR. Only administrators can create a bucket CR and configure it. 
...
1. Create an S3 object store server in the SVM in ONTAP Cluster.
...
image:rh-os-n-use-case-ocpv-tp-dp-008.png[ONTAP S3 Appvault created]
====
...
image:rh-os-n-use-case-ocpv-tp-dp-001.png[default storage class]

image:rh-os-n-use-case-ocpv-tp-dp-002.png[create fedora VM]

image:rh-os-n-use-case-ocpv-tp-dp-003.png[template default]

image:rh-os-n-use-case-ocpv-tp-dp-004.png[customize]

image:rh-os-n-use-case-ocpv-tp-dp-005.png[Add disk]

image:rh-os-n-use-case-ocpv-tp-dp-006.png[disk added]

image:rh-os-n-use-case-ocpv-tp-dp-007.png[vm, pods and pvc created]
====
...
In the example, the demo namespace has one VM and all resources of the namespace are included when creating the app.
...
image:rh-os-n-use-case-ocpv-tp-dp-009.png[App created]
====
...
image:rh-os-n-use-case-ocpv-tp-dp-015.png[On-demand backup created]
...
image:rh-os-n-use-case-ocpv-tp-dp-016.png[Backup Schedule created]

image:rh-os-n-use-case-ocpv-tp-dp-017.png[Backups created on demand and on Schedule]
====
...
image:rh-os-n-use-case-ocpv-tp-dp-019.png[fedora-vm deleted]
...
image:rh-os-n-use-case-ocpv-tp-dp-020.png[bir created]

Verify that the VM, pods and PVCs are restored

image:rh-os-n-use-case-ocpv-tp-dp-021.png[VM restored created]
...
image:rh-os-n-use-case-ocpv-tp-dp-022.png[br created]

Verify that the VM, pods and pvcs are created in the new namespace demo2.

image:rh-os-n-use-case-ocpv-tp-dp-023.png[VM in the new namespace]
====
...
....
image:rh-os-n-use-case-ocpv-tp-dp-023.png[ondemand snapshot]
...
image:rh-os-n-use-case-ocpv-tp-dp-025.png[schedule for snapshots]

image:rh-os-n-use-case-ocpv-tp-dp-026.png[scheduled snapshot]
====
...
image:rh-os-n-use-case-ocpv-tp-dp-030.png[vm delete]
...
image:rh-os-n-use-case-ocpv-tp-dp-027.png[sir]

Verify that the VM and its PVCs are created in the demo namespace.

image:rh-os-n-use-case-ocpv-tp-dp-031.png[vm restored in same namespace]
...
image:rh-os-n-use-case-ocpv-tp-dp-028.png[Delete VM, PVCs]
...
image:rh-os-n-use-case-ocpv-tp-dp-029.png[SR created]

Verify that the VM and its PVCs are restored in the new namespace demo2.

image:rh-os-n-use-case-ocpv-tp-dp-032.png[VM restored in new namespace]
====
...
image:rh-os-n-use-case-ocpv-tp-dp-010.png[demo-centos VM in the demo namespace]

***Label the demo-centos vm and its associated resources***

image:rh-os-n-use-case-ocpv-tp-dp-011.png[label demo-centos vm, pvc]

***Verify that the demo-centos vm and pvcs got the labels***

image:rh-os-n-use-case-ocpv-tp-dp-012.png[demo-centos vm labels]

image:rh-os-n-use-case-ocpv-tp-dp-013.png[demo-centos pvc got labels]
...
image:rh-os-n-use-case-ocpv-tp-dp-014.png[demo-centos pvc got labels]
...
image:rh-os-n-use-case-ocpv-tp-dp-018.png[Backup of specific VM created]
...
image:rh-os-n-use-case-ocpv-tp-dp-033.png[Centos VM present]

image:rh-os-n-use-case-ocpv-tp-dp-034.png[Centos VM deleted]
...
image:rh-os-n-use-case-ocpv-tp-dp-035.png[create centos vm bir]

image:rh-os-n-use-case-ocpv-tp-dp-036.png[centos vm created]
...
image:rh-os-n-use-case-ocpv-tp-dp-037.png[create centos vm bir]

image:rh-os-n-use-case-ocpv-tp-dp-038.png[centos vm created]
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_openshift_virtualization_tp_dp_overview.adoc
