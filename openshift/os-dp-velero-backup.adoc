...
image:redhat-openshift-oadp-backup-004.png[Scheduled backup completed]
...
// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-dp-velero-backup.adoc
