...
image:redhat-openshift-oadp-install-001.png[OpenShift API for Data Protection in Operator Hub]

image:redhat-openshift-oadp-install-002.png[OpenShift API for Data Protection Operator installation]

image:redhat-openshift-oadp-install-003.png[OpenShift API for Data Protection Operator installed]
...
image:redhat-openshift-oadp-install-004.png[Secret for S3 user credentials]

image:redhat-openshift-oadp-install-005.png[Create Secret for S3 user credentials]

To create a secret named sg-s3-credentials from the CLI you can use the following command. 

image:redhat-openshift-oadp-install-006.png[Create Secret for Storage Grid S3 user credentials using CLI]
...
image:redhat-openshift-oadp-install-007.png[DataProtectionApplication]
...
image:redhat-openshift-oadp-install-008.png[Create DataProtectionApplication]
...
image:redhat-openshift-oadp-install-009.png[Trident Snapshot class Label]
...
image:redhat-openshift-oadp-install-010.png[VolumeSnapshotClass deletion Policy should be set to Retain]

Ensure that the DataProtectionApplication is created and is in condition:Reconciled.

image:redhat-openshift-oadp-install-011.png[DataProtectionApplication Object is created]

The OADP operator will create a corresponding BackupStorageLocation.This will be used when creating a backup.

image:redhat-openshift-oadp-install-012.png[BackupStorageLocation is created]

// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-dp-velero-installation.adoc
