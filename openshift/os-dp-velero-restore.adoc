...
image:redhat-openshift-oadp-app-deleted-001.png[App deleted]
...
image:redhat-openshift-oadp-restore-002-a.png[Restored to same namespace]
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-dp-velero-restore.adoc
