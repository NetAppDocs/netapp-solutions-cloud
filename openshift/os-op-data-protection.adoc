...
For details about protecting using Trident protect review the following sections:
- link:../openshift/os-dp-tp-solution.html[Protect Container apps using Trident Protect]
- link:../openshift/os-dp-tp-solution.html[Protect VMs apps using Trident Protect]
