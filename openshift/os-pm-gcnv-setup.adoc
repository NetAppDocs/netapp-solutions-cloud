...
* Use a Helm chart to install Trident on OSD clusters. Refer link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-helm.html[here] for instructions on how to install the Helm Chart. 
...
// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-pm-gcnv-setup.adoc
