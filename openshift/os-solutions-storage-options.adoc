...
image:a-w-n-astra-trident.png["Figure showing input/output dialog or representing written content"]
...
image:rhhc-storage-opt-pod2vol.png[Pod to ONTAP Volume relationship]
...
image:rhhc-storage-options-fsxn-options.png["Replication between Multi-AZ and Single-AZ"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from rhhc/rhhc-storage-options.adoc
