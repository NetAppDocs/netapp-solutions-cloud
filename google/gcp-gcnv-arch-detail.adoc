...
The following figure, referenced from the https://docs.cloud.google.com/netapp/volumes/docs[Google Cloud NetApp Volumes documentation^], reviews a high-level view.

image:ncvs-gc-001.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-003.png["Figure showing input/output dialog or representing written content"]

image:ncvs-gc-004.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/ncvs-gc-cloud-volumes-service-architecture.adoc
