...
* If Windows names and UNIX names do not match identically, then LDAP must be configured to allow Google Cloud NetApp Volumes to use the LDAP name mapping configuration (see the section link:gcp-gcnv-nas-dependencies.html#using-ldap-for-asymmetric-name-mapping["Using LDAP for asymmetric name mapping"]).
...
image:ncvs-gc-006.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-007.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-008.png["Figure showing input/output dialog or representing written content"]

In a packet capture, we can see the Session Setup Request using the SPN tied to the CNAME.

image:ncvs-gc-009.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-010.png["Figure showing input/output dialog or representing written content"]

image:ncvs-gc-011.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-012.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-013.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-014.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-015.png["Figure showing input/output dialog or representing written content"]

image:ncvs-gc-016.png["Figure showing input/output dialog or representing written content"]
...
image:ncvs-gc-017.png["Figure showing input/output dialog or representing written content"]

image:ncvs-gc-018.png["Figure showing input/output dialog or representing written content"]
...
|Sets signing and/or sealing for LDAP communication. This is not currently set in Google Cloud NetApp Volumes but might be needed in future releases to address . Remediation for LDAP authentication issues due to the Windows patch is covered in the section link:gcp-gcnv-nas-dependencies.html#ldap-channel-binding["LDAP channel binding."].
|None
|No
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/ncvs-gc-smb.adoc
