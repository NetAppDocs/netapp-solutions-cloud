...
If you have questions about the content of this technical report, see the section link:../vmware/gcp-gcnv-additional-info.html#contact-us["Contact us."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ehc/ncvs-gc-overview.adoc
