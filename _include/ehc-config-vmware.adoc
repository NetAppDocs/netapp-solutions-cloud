...
// tag::ehc-aws[]
View the detailed link:../vmware/vmw-aws-vmc-setup.html[configuration steps for VMC].
// end::ehc-aws[]
...
// tag::ehc-azure[]
View the detailed link:../vmware/vmw-azure-avs-setup.html[configuration steps for AVS].
// end::ehc-azure[]
...
// tag::ehc-gcp[]
View the detailed link:../vmware/vmw-gcp-gcve-setup.html[configuration steps for GCVE].
// end::ehc-gcp[]
