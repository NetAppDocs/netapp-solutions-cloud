...
// tag::ehc-aws[]
View the detailed link:../vmware/vmw-aws-vmc-guest-storage.html[guest connect storage options for VMC].
View the detailed link:../vmware/vmw-aws-vmc-nfs-ds-config.html[supplemental NFS datastore options for VMC].
// end::ehc-aws[]
...
// tag::ehc-azure[]
View the detailed link:../vmware/vmw-azure-avs-guest-storage.html[guest connect storage options for AVS].
View the detailed link:../vmware/vmw-azure-avs-nfs-ds-config.html[supplemental NFS datastore options for AVS].
// end::ehc-azure[]
...
// tag::ehc-gcp[]
View the detailed link:../vmware/vmw-gcp-gcve-guest-storage.html[guest connect storage options for GCVE].
View the detailed link:../vmware/vmw-gcp-gcve-nfs-ds-overview.html[supplemental NFS datastore options for GCVE].
